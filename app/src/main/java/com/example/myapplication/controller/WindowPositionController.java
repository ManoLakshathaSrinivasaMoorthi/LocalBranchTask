...
import com.example.myapplication.interfaces.ListItemAction;
...
public class WindowPositionController implements ListItemAction, NetworkTask.NetworkTaskListener {
    ...
    public void onCreate() {
        ...
        if (mainContainer == null) {
            ...
            close.setOnClickListener(v -> searchedItemView.setVisibility(searchedItemView.getVisibility() == View.VISIBLE ? View.GONE : View.VISIBLE));
